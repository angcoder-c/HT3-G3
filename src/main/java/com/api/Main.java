...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        String algorithm = IOApp.getParam(args, "--whith-algoritm"); 
    ...
    private static void printHelp () {
        ...
        Ordenar desde un archivo existente:
            ...
            --whith-algoritm <name> => nombre del algoritmo con el que se desea procesar.
            ...
            java -cp out com.api.Main --order-file ./input.txt --whith-algoritm quicksort --dir ./carpeta --output-filename ordenado.txt   
